...
Project Overview
For this project, I took on the role of a Student Digital Ambassador. The goal of this repository is to showcase essential digital skills required for academic and professional success, ranging from creating professional online profiles to communicating safely and responsibly online. 

This repository contains the deliverables for all five modules of the Digital Literacy course.
...
task-2-portfolio/
- Contains screenshots and links to my professional digital profiles (GitHub, LinkedIn, ResearchGate).

task-3-platforms/
- Contains my HackerRank certificates (Python, Problem Solving) and screenshots/links to my Google Workspace collaboration task.
